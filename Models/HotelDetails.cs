...
namespace TravelBridgeAPI.Models.HotelDetails
{
    ...
    public class Data
    {
        ...
        public object[] hotel_important_information_with_codes { get; set; }
    ...
    public class Rooms
    {
        public _595518907 _595518907 { get; set; }
    }

    public class _595518907
    {
    ...
    public class Group_By_Price
    {
        ...
        public string[] fixedper_night818 { get; set; }
    }
    ...
    {
        public Benefit2[] benefits { get; set; }
